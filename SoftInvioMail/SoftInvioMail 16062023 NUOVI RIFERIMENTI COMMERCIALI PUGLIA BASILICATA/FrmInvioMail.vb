        ...
        If InviaEmail() = True Then
            ...
            Else 'ASPETTO OPERAZIONI DA SOFTAZIENDA eventuali correzioni email e altri tipi di errore
                ...
                If NEmailErrate > 0 Then
                    LblInvio.Text = "ATTESA INVIO EMAIL (REG.16062023)" & NEmailDaInviare.ToString & "/" & NEmailInviate.ToString & " ERR.: " & NEmailErrate.ToString
                Else
                    LblInvio.Text = "ATTESA INVIO EMAIL (REG.16062023)" & NEmailDaInviare.ToString & "/" & NEmailInviate.ToString & " ERR.: " & NEmailErrate.ToString
                End If
                ErrMess = LblInvio.Text
            ...
            For Each RowEmailT In DsEmailDaInviare.EmailInviateTOggetto.Select("Stato<>-1", "ID")
                ...
                If ErrInvio = False Then
                    With objEmail
                        ...
                        'OGGETTO
                        .Subject = IIf(InvioTest = True, "!!! VERIFICARE SE TUTTO CORRETTO GRAZIE !!! - NUOVI RIFERIMENTI COMMERCIALI", "NUOVI RIFERIMENTI COMMERCIALI")
                        ...
                        .Body += "con riferimento alla ns precedente mail, Vi comunichiamo che il Vs nuovo contatto per le Regioni Puglia e Basilicata è il seguente:  <br /><br />"

                        .Body += "TEXA SRL <br />"
                        .Body += "VIALE VIRGILIO 2/25 <br />"
                        .Body += "71100 FOGGIA<br />"
                        .Body += "TEL. 0881 889112 – E-MAIL: "
                        .Body += "<a href=""mailto:m.fioretti@texafoggia.it?Subject=Comunicazione"" target=""_top"">m.fioretti@texafoggia.it</a><br /><br />"

                        .Body += "Persona di contatto: <br />"
                        .Body += "SIG. RASPATELLI STEFANO – CELL 340 4893469 <br />"
                        .Body += "E-MAIL: "
                        .Body += "<a href=""mailto:s.raspatelli@texafoggia.it?Subject=Comunicazione"" target=""_top"">s.raspatelli@texafoggia.it</a><br /><br />"

                        .Body += "Vi ringraziamo della Vostra attenzione.<br /><br />"
                        .Body += "Restando a disposizione per ogni eventuale chiarimento, porgiamo cordiali saluti.<br /><br />"
