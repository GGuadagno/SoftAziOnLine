...
Partial Public Class WFP_FatturaOC
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If (WUCFatturaOC.PopolaLista()) Then
            Session(F_EVASIONEPARZ_APERTA) = False
            lblMessUtente.Text = ""
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPFatturaParzOC()
        Else
    ...
    Protected Sub btnSelTutti_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        WUCFatturaOC.SelezionaTutti()
    End Sub

    Protected Sub btnDeselTutti_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        WUCFatturaOC.DeselezionaTutti()
    End Sub

    Public Sub Show(Optional ByVal PrimaVolta As Boolean = False)
        If PrimaVolta Then
            lblMessUtente.Text = "Seleziona/modifica Quantità articoli da fatturare"
            WUCFatturaOC.SelAndQtaTutti()
        End If
