...
Partial Public Class WFP_Vettori
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            lblMessUtente.Text = ""
        End If
        WUC_Vettori.WucElement = Me
    End Sub

    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If Session(SWOPLOC) = SWOPNUOVO Then
            If CheckNewNumeroOnTab(CheckNewNumeroOnTab(WUC_Vettori.GetNewCodice)) = False Then
                Exit Sub
            End If
        End If
        Session(SWOPLOC) = SWOPNESSUNA
        If (WUC_Vettori.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPAnagrVettori()
    ...
    Private Function CheckNewNumeroOnTab(ByVal myID As Int32) As Boolean
        ...
        Dim strSQL As String = "Select Codice From Vettori WHERE Codice = " & myID.ToString.Trim
        ...
        Try
            ...
            If (ds.Tables.Count > 0) Then
                If (ds.Tables(0).Rows.Count > 0) Then
                    ...
                    'ModalPopup.Show("Attenzione", "Numero documento giÃ  presente in tabella", WUC_ModalPopup.TYPE_ALERT)
                    lblMessUtente.Text = "Attenzione, Codice Vettore già presente in tabella"
                    Exit Function
                Else
        ...
        Catch Ex As Exception
            ...
            lblMessUtente.Text = "Errore, Verifica codice Vettore da impegnare: " & Ex.Message
            Exit Function
        End Try
    End Function
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session(SWOPLOC) = SWOPNESSUNA
        ProgrammaticModalPopup.Hide()
        WUC_Vettori.SvuotaCampi()
        _WucElement.CancBackWFPAnagrVettori()
        Session(F_ANAGRVETTORI_APERTA) = False
    End Sub
    Protected Sub btnNuovo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        WUC_Vettori.SetNewCodice(GetNewCodice)
    End Sub
    Private Function GetNewCodice() As Long
        Dim strSQL As String = ""
        strSQL = "Select MAX(ISNULL(Codice,0)) AS Codice From Vettori"
        Dim ObjDB As New DataBaseUtility
        Dim ds As New DataSet
        Try
            ObjDB.PopulateDatasetFromQuery(TipoDB.dbSoftCoge, strSQL, ds)
