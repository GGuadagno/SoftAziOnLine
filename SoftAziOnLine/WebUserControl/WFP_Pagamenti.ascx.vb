...
Partial Public Class WFP_Pagamenti
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            lblMessUtente.Text = ""
        End If
        WUC_Pagamenti.WucElement = Me
    End Sub

    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If Session(SWOPLOC) = SWOPNUOVO Then
            If CheckNewNumeroOnTab(CheckNewNumeroOnTab(WUC_Pagamenti.GetNewCodice)) = False Then
                Exit Sub
            End If
        End If
        Session(SWOPLOC) = SWOPNESSUNA
        If (WUC_Pagamenti.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPPagamenti()
    ...
    Private Function CheckNewNumeroOnTab(ByVal myID As Int32) As Boolean
        ...
        Dim strSQL As String = "Select Codice From Pagamenti WHERE Codice = " & myID.ToString.Trim
        ...
        Try
            ...
            If (ds.Tables.Count > 0) Then
                If (ds.Tables(0).Rows.Count > 0) Then
                    ...
                    lblMessUtente.Text = "Attenzione, Codice Pagamento già presente in tabella"
                    Exit Function
                Else
        ...
        Catch Ex As Exception
            ...
            lblMessUtente.Text = "Errore, Verifica codice Pagamento da impegnare: " & Ex.Message
            Exit Function
        End Try
    End Function
    ...
    Protected Sub btnNuovo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        WUC_Pagamenti.SetNewCodice(GetNewCodice)
    End Sub
    Private Function GetNewCodice() As Long
        Dim strSQL As String = ""
        strSQL = "Select MAX(ISNULL(Codice,0)) AS Codice From Pagamenti"
        Dim ObjDB As New DataBaseUtility
        Dim ds As New DataSet
        Try
            ObjDB.PopulateDatasetFromQuery(TipoDB.dbSoftCoge, strSQL, ds)
