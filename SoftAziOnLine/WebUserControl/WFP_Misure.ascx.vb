...
Partial Public Class WFP_Misure
    ...
    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If (WUC_Misure.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPAnagrMisure()
    ...
    Private Function CheckNewNumeroOnTab(ByVal Codice As String) As Boolean
        ...
        Dim strSQL As String = "Select Codice From Misure WHERE Codice = '" & Codice.ToString.Trim & "'"
        ...
        Try
            ...
            If (ds.Tables.Count > 0) Then
                If (ds.Tables(0).Rows.Count > 0) Then
                    lblMessUtente.Text = "Attenzione, Codice Misura già presente in tabella"
                    Exit Function
                Else
            ...
            End If
        Catch Ex As Exception
            lblMessUtente.Text = "Errore, Verifica codice Misura da impegnare: " & Ex.Message
            Exit Function
        End Try
    End Function
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session(SWOPLOC) = SWOPNESSUNA
        ProgrammaticModalPopup.Hide()
        WUC_Misure.SvuotaCampi()
        _WucElement.CancBackWFPAnagrMisure()
        Session(F_ANAGRMISURE_APERTA) = False
    End Sub
