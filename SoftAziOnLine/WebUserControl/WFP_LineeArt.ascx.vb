...
Partial Public Class WFP_LineeArt
    ...
    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If (WUC_LineeArt.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPAnagrLineeArt()
    ...
    Private Function CheckNewNumeroOnTab(ByVal Codice As String) As Boolean
        ...
        Dim strSQL As String = "Select Codice From LineeArt WHERE Codice = '" & Codice.ToString.Trim & "'"
        ...
        Try
            ...
            If (ds.Tables.Count > 0) Then
                If (ds.Tables(0).Rows.Count > 0) Then
                    lblMessUtente.Text = "Attenzione, Codice Linea già presente in tabella"
                    Exit Function
                Else
            ...
            End If
        Catch Ex As Exception
            lblMessUtente.Text = "Errore, Verifica codice Linea da impegnare: " & Ex.Message
            Exit Function
        End Try
    End Function
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session(SWOPLOC) = SWOPNESSUNA
        ProgrammaticModalPopup.Hide()
        WUC_LineeArt.SvuotaCampi()
        _WucElement.CancBackWFPAnagrLineeArt()
        Session(F_ANAGRLINEEART_APERTA) = False
    End Sub
