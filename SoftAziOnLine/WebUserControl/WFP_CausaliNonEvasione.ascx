<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_CausaliNonEvasione.ascx.vb" Inherits="SoftAziOnLine.WFP_CausaliNonEvasione" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_CausaliNonEvasione.ascx" TagName="WUCCausaliNonEvasione" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <wuc:WUCCausaliNonEvasione ID="WUC_CausaliNonEvasione" runat="server" />
    </asp:Panel>
    <asp:Panel ID="Panel3" runat="server" Height="25px"><asp:Label ID="lblMessUtente" 
                ...
                Style="text-align:center" Text="" Width="100%"></asp:Label>
        </asp:Panel>  
    <br />         
