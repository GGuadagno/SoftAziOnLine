<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_DestCliFor.ascx.vb" Inherits="SoftAziOnLine.WFP_DestCliFor" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_DestCliFor.ascx" TagName="DestCliFor" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <wuc:DestCliFor ID="WUC_DestCliFor" runat="server" />
    </asp:Panel>
    <br />        
    <div style="text-align:center;">    
        <asp:Button ID="btnAggiorna" runat="server" Text="Aggiorna" OnClick="btnAggiorna_Click" />
        <asp:Button ID="btnNuovo" runat="server" Text="Nuova Destinazione" OnClick="btnNuovo_Click" />
