...
Partial Public Class WFP_ResoAFornitore
    ...
    Protected Sub btnOk_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If (WUCResoAFornitore.PopolaLista()) Then
            Session(F_RESOAF_APERTA) = False
            lblMessUtente.Text = ""
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPResoAFornitore()
        Else
