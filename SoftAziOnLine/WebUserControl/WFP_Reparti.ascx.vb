...
Partial Public Class WFP_Reparti
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) Then
            ...
            lblMessUtente.Text = ""
        End If
        WUC_Reparti.WucElement = Me
    End Sub

    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If Session(SWOPLOC) = SWOPNUOVO Then
            If CheckNewNumeroOnTab(CheckNewNumeroOnTab(WUC_Reparti.GetNewCodice)) = False Then
                Exit Sub
            End If
        End If
        Session(SWOPLOC) = SWOPNESSUNA
        If (WUC_Reparti.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPReparti()
    ...
    Private Function CheckNewNumeroOnTab(ByVal _ID As Int32) As Boolean
        ...
        Dim strSQL As String = "Select Codice From Reparti WHERE Magazzino=" & myIDMag.Trim
        strSQL += " AND Codice = " & _ID.ToString.Trim
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session(SWOPLOC) = SWOPNESSUNA
        ProgrammaticModalPopup.Hide()
        WUC_Reparti.SvuotaCampi()
        _WucElement.CancBackWFPReparti()
        Session(F_ANAGRREP_APERTA) = False
    End Sub
    Protected Sub btnNuovo_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        WUC_Reparti.SetNewCodice(GetNewCodice)
    End Sub
    Private Function GetNewCodice() As Long
        ...
        strSQL = "Select MAX(ISNULL(Codice,0)) AS Codice From Reparti WHERE Magazzino=" & myIDMag.Trim
        Dim ObjDB As New DataBaseUtility
        Dim ds As New DataSet
        Try
            ObjDB.PopulateDatasetFromQuery(TipoDB.dbSoftAzi, strSQL, ds)
