<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_NotaCreditoCliente.ascx.vb" Inherits="SoftAziOnLine.WFP_NotaCreditoCliente" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_NotaCreditoCliente.ascx" TagName="NotaCreditoCliente" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="NOTA CREDITO CLIENTE (DA FATTURA)" Width="99%"></asp:Label>
        <wuc:NotaCreditoCliente ID="WUCNotaCreditoCliente" runat="server" />
    </asp:Panel>
    ...
    <div style="text-align:center;">    
        <asp:Button ID="btnOk" runat="server" Text="OK Crea Nota di Credito" OnClick="btnOk_Click" />
