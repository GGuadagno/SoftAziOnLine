<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_CambiaStatoOF.ascx.vb" Inherits="SoftAziOnLine.WFP_CambiaStatoOF" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_CambiaStatoOF.ascx" TagName="CambiaStatoOF" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="CAMBIO STATO ORDINI FORNITORE" Width="99%"></asp:Label>
        <wuc:CambiaStatoOF ID="WUCCambiaStatoOF" runat="server" />
    </asp:Panel>
