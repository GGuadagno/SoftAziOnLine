...
Partial Public Class WFP_CategorieArt
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            lblMessUtente.Text = ""
        End If
        WUC_CategorieArt.WucElement = Me
    End Sub
    ...
    Protected Sub btnAggiorna_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If (WUC_CategorieArt.Aggiorna()) Then
            ProgrammaticModalPopup.Hide()
            _WucElement.CallBackWFPAnagrCategorieArt()
    ...
    Private Function CheckNewNumeroOnTab(ByVal Codice As String) As Boolean
        ...
        Dim strSQL As String = "Select Codice From CategArt WHERE Codice = '" & Codice.ToString.Trim & "'"
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Session(SWOPLOC) = SWOPNESSUNA
        ProgrammaticModalPopup.Hide()
        WUC_CategorieArt.SvuotaCampi()
        _WucElement.CancBackWFPAnagrCategorieArt()
        Session(F_ANAGRCATEGORIEART_APERTA) = False
    End Sub
