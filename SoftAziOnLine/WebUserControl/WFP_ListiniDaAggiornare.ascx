<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_ListiniDaAggiornare.ascx.vb" Inherits="SoftAziOnLine.WFP_ListiniDaAggiornare" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_ListiniDaAggiornare.ascx" TagName="ListiniDaAggiornare" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <wuc:ListiniDaAggiornare ID="WUCListiniDaAggiornare" runat="server" />
    </asp:Panel>
    ...
    <div style="text-align:center;">    
        ...
        <asp:Button ID="btnSelTutti" runat="server" Text="Seleziona tutti i listini" OnClick="btnSelTutti_Click" />
        <asp:Button ID="btnDeselTutti" runat="server" Text="Deseleziona tutti i listini" OnClick="btnDeselTutti_Click" />
    </div>
   <br />
</asp:Panel>
