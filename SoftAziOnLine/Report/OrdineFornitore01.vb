...
Public Class OrdineFornitore01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineFornitore01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineFornitore01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineFornitore01 = New OrdineFornitore01()
        rpt.Site = Me.Site
        Return rpt
    End Function
