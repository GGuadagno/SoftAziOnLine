...
Public Class rptCFPivaDoppi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptCFPivaDoppi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCFPivaDoppi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCFPivaDoppi = New rptCFPivaDoppi()
        rpt.Site = Me.Site
        Return rpt
    End Function
