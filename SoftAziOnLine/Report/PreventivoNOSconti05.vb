...
Public Class PreventivoNOSconti05
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PreventivoNOSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.PreventivoNOSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreventivoNOSconti05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreventivoNOSconti05 = New PreventivoNOSconti05()
        rpt.Site = Me.Site
        Return rpt
    End Function
