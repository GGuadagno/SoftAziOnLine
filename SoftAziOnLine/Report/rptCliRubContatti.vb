...
Public Class rptCliRubContatti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptCliRubContatti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCliRubContatti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCliRubContatti = New rptCliRubContatti()
        rpt.Site = Me.Site
        Return rpt
    End Function
