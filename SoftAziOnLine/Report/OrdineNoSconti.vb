...
Public Class OrdineNoSconti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineNoSconti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineNoSconti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineNoSconti = New OrdineNoSconti()
        rpt.Site = Me.Site
        Return rpt
    End Function
