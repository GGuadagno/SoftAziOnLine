...
Public Class StVendRegCatArt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StVendRegCatArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStVendRegCatArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StVendRegCatArt = New StVendRegCatArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
