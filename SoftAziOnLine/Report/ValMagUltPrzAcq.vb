...
Public Class ValMagUltPrzAcq
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValMagUltPrzAcq.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValMagUltPrzAcq
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValMagUltPrzAcq = New ValMagUltPrzAcq()
        rpt.Site = Me.Site
        Return rpt
    End Function
