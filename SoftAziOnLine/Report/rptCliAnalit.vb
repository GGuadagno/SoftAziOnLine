...
Public Class rptCliAnalit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptCliAnalit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCliAnalit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCliAnalit = New rptCliAnalit()
        rpt.Site = Me.Site
        Return rpt
    End Function
