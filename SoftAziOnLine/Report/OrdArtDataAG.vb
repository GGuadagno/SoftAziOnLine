...
Public Class OrdArtDataAG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdArtDataAG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdArtDataAG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdArtDataAG = New OrdArtDataAG()
        rpt.Site = Me.Site
        Return rpt
    End Function
