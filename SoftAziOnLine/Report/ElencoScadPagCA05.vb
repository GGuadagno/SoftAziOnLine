...
Public Class ElencoScadPagCA05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoScadPagCA05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoScadPagCA05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoScadPagCA05 = New ElencoScadPagCA05()
        rpt.Site = Me.Site
        Return rpt
    End Function
