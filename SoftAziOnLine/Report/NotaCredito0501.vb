...
Public Class NotaCredito0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.NotaCredito0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCredito0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCredito0501 = New NotaCredito0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
