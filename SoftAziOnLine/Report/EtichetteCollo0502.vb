...
Public Class EtichetteCollo0502
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteCollo0502.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteCollo0502
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteCollo0502 = New EtichetteCollo0502()
        rpt.Site = Me.Site
        Return rpt
    End Function
