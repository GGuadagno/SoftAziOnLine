...
Public Class NotaCredito05LT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.NotaCredito05LT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCredito05LT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCredito05LT = New NotaCredito05LT()
        rpt.Site = Me.Site
        Return rpt
    End Function
