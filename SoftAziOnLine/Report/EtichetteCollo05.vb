...
Public Class EtichetteCollo05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteCollo05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteCollo05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteCollo05 = New EtichetteCollo05()
        rpt.Site = Me.Site
        Return rpt
    End Function
