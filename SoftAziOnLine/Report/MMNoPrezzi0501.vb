...
Public Class MMNoPrezzi0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.MMNoPrezzi0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMMNoPrezzi0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MMNoPrezzi0501 = New MMNoPrezzi0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
