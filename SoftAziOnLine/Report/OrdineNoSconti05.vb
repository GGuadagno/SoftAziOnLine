...
Public Class OrdineNoSconti05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineNoSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineNoSconti05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineNoSconti05 = New OrdineNoSconti05()
        rpt.Site = Me.Site
        Return rpt
    End Function
