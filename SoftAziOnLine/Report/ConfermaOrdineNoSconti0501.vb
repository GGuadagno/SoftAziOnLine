...
Public Class ConfermaOrdineNoSconti0501
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConfermaOrdineNoSconti0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdineNoSconti0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdineNoSconti0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdineNoSconti0501 = New ConfermaOrdineNoSconti0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
