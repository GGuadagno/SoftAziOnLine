...
Public Class NotaCredito01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.NotaCredito01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCredito01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCredito01 = New NotaCredito01()
        rpt.Site = Me.Site
        Return rpt
    End Function
