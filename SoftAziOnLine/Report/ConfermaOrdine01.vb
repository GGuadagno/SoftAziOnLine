...
Public Class ConfermaOrdine01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdine01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdine01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdine01 = New ConfermaOrdine01()
        rpt.Site = Me.Site
        Return rpt
    End Function
