...
Public Class StOrdArtCliAg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StOrdArtCliAg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStOrdArtCliAg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StOrdArtCliAg = New StOrdArtCliAg()
        rpt.Site = Me.Site
        Return rpt
    End Function
