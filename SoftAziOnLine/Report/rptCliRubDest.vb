...
Public Class rptCliRubDest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptCliRubDest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCliRubDest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCliRubDest = New rptCliRubDest()
        rpt.Site = Me.Site
        Return rpt
    End Function
