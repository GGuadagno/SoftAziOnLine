...
Public Class EtichetteCollo0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteCollo0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteCollo0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteCollo0501 = New EtichetteCollo0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
