...
Public Class StOrdArtCliFor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StOrdArtCliFor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStOrdArtCliFor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StOrdArtCliFor = New StOrdArtCliFor()
        rpt.Site = Me.Site
        Return rpt
    End Function
