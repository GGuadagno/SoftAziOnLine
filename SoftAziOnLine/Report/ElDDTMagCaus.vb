...
Public Class ElDDTMagCaus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElDDTMagCaus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElDDTMagCaus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElDDTMagCaus = New ElDDTMagCaus()
        rpt.Site = Me.Site
        Return rpt
    End Function
