...
Public Class StVendAgCategArt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StVendAgCategArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStVendAgCategArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StVendAgCategArt = New StVendAgCategArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
