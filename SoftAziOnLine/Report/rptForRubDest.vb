...
Public Class rptForRubDest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptForRubDest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptForRubDest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptForRubDest = New rptForRubDest()
        rpt.Site = Me.Site
        Return rpt
    End Function
