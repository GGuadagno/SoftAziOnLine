...
Public Class rptForAnalit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptForAnalit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptForAnalit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptForAnalit = New rptForAnalit()
        rpt.Site = Me.Site
        Return rpt
    End Function
