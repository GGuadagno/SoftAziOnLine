...
Public Class rptIncNCFatt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptIncNCFatt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIncNCFatt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIncNCFatt = New rptIncNCFatt()
        rpt.Site = Me.Site
        Return rpt
    End Function
