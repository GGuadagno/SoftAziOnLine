...
Public Class MovMagPerArt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.MovMagPerArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMovMagPerArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MovMagPerArt = New MovMagPerArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
