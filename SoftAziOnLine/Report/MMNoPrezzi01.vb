...
Public Class MMNoPrezzi01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.MMNoPrezzi01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMMNoPrezzi01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MMNoPrezzi01 = New MMNoPrezzi01()
        rpt.Site = Me.Site
        Return rpt
    End Function
