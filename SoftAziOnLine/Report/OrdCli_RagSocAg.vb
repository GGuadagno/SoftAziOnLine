...
Public Class OrdCli_RagSocAg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdCli_RagSocAg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdCli_RagSocAg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdCli_RagSocAg = New OrdCli_RagSocAg()
        rpt.Site = Me.Site
        Return rpt
    End Function
