...
Public Class VerbaleVACA05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.VerbaleVACA05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVerbaleVACA05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VerbaleVACA05 = New VerbaleVACA05
        rpt.Site = Me.Site
        Return rpt
    End Function
