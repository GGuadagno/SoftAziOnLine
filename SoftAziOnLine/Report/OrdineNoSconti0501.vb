...
Public Class OrdineNoSconti0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineNoSconti0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineNoSconti0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineNoSconti0501 = New OrdineNoSconti0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
