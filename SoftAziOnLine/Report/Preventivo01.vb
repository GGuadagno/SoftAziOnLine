...
Public Class Preventivo01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.Preventivo01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreventivo01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Preventivo01 = New Preventivo01()
        rpt.Site = Me.Site
        Return rpt
    End Function
