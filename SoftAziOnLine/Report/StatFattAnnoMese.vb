...
Public Class StatFattAnnoMese
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StatFattAnnoMese.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatFattAnnoMese
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatFattAnnoMese = New StatFattAnnoMese()
        rpt.Site = Me.Site
        Return rpt
    End Function
