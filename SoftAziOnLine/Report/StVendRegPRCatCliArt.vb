...
Public Class StVendRegPRCatCliArt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StVendRegPRCatCliArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StVendRegPRCatCliArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PrezzoX() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStVendRegPRCatCliArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StVendRegPRCatCliArt = New StVendRegPRCatCliArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
