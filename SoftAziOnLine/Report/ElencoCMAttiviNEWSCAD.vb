...
Public Class ElencoCMAttiviNEWSCAD
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ElencoCMAttiviNEWSCAD.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoCMAttiviNEWSCAD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoCMAttiviNEWSCAD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoCMAttiviNEWSCAD = New ElencoCMAttiviNEWSCAD()
        rpt.Site = Me.Site
        Return rpt
    End Function
