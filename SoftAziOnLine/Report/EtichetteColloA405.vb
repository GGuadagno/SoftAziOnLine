...
Public Class EtichetteColloA405
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteColloA405.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteColloA405
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteColloA405 = New EtichetteColloA405()
        rpt.Site = Me.Site
        Return rpt
    End Function
