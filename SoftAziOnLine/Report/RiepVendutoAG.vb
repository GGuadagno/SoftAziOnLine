...
Public Class RiepVendutoAG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.RiepVendutoAG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRiepVendutoAG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RiepVendutoAG = New RiepVendutoAG()
        rpt.Site = Me.Site
        Return rpt
    End Function
