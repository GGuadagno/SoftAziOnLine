...
Public Class MMNoPrezzi05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.MMNoPrezzi05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMMNoPrezzi05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MMNoPrezzi05 = New MMNoPrezzi05()
        rpt.Site = Me.Site
        Return rpt
    End Function
