...
Public Class ValCMSMCliForNDoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValCMSMCliForNDoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValCMSMCliForNDoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValCMSMCliForNDoc = New ValCMSMCliForNDoc()
        rpt.Site = Me.Site
        Return rpt
    End Function
