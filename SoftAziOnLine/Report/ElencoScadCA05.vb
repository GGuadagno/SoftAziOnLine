...
Public Class ElencoScadCA05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoScadCA05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoScadCA05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoScadCA05 = New ElencoScadCA05()
        rpt.Site = Me.Site
        Return rpt
    End Function
