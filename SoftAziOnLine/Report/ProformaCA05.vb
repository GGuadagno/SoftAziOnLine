...
Public Class ProformaCA05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ProformaCA05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProformaCA05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProformaCA05 = New ProformaCA05()
        rpt.Site = Me.Site
        Return rpt
    End Function
