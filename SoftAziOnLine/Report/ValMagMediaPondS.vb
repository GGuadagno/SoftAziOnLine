...
Public Class ValMagMediaPondS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValMagMediaPondS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValMagMediaPondS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValMagMediaPondS = New ValMagMediaPondS()
        rpt.Site = Me.Site
        Return rpt
    End Function
