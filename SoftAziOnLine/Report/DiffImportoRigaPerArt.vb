...
Public Class DiffImportoRigaPerArt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DiffImportoRigaPerArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.DiffImportoRigaPerArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDiffImportoRigaPerArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DiffImportoRigaPerArt = New DiffImportoRigaPerArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
