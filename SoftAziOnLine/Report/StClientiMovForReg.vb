...
Public Class StClientiMovForReg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StClientiMovForReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStClientiMovForReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StClientiMovForReg = New StClientiMovForReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
