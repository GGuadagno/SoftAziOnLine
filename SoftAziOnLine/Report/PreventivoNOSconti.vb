...
Public Class PreventivoNOSconti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.PreventivoNOSconti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreventivoNOSconti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PreventivoNOSconti = New PreventivoNOSconti()
        rpt.Site = Me.Site
        Return rpt
    End Function
