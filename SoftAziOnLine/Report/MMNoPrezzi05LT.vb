...
Public Class MMNoPrezzi05LT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.MMNoPrezzi05LT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMMNoPrezzi05LT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MMNoPrezzi05LT = New MMNoPrezzi05LT()
        rpt.Site = Me.Site
        Return rpt
    End Function
