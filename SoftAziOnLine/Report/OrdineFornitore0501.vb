...
Public Class OrdineFornitore0501
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OrdineFornitore0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineFornitore0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineFornitore0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineFornitore0501 = New OrdineFornitore0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
