...
Public Class OrdCli_RagSoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdCli_RagSoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdCli_RagSoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdCli_RagSoc = New OrdCli_RagSoc()
        rpt.Site = Me.Site
        Return rpt
    End Function
