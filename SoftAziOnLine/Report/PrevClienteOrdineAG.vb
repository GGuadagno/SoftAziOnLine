...
Public Class PrevClienteOrdineAG
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrevClienteOrdineAG.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.PrevClienteOrdineAG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrevClienteOrdineAG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrevClienteOrdineAG = New PrevClienteOrdineAG()
        rpt.Site = Me.Site
        Return rpt
    End Function
