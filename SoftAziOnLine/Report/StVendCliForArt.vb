...
Public Class StVendCliForArt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StVendCliForArt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStVendCliForArt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StVendCliForArt = New StVendCliForArt()
        rpt.Site = Me.Site
        Return rpt
    End Function
