...
Public Class Preventivo05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.Preventivo05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreventivo05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Preventivo05 = New Preventivo05()
        rpt.Site = Me.Site
        Return rpt
    End Function
