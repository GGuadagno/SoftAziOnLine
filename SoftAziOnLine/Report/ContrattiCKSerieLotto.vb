...
Public Class ContrattiCKSerieLotto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ContrattiCKSerieLotto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ContrattiCKSerieLotto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedContrattiCKSerieLotto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ContrattiCKSerieLotto = New ContrattiCKSerieLotto()
        rpt.Site = Me.Site
        Return rpt
    End Function
