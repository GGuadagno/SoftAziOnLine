...
Public Class ElencoAICliCategoria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ElencoAICliCategoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoAICliCategoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoAICliCategoria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoAICliCategoria = New ElencoAICliCategoria()
        rpt.Site = Me.Site
        Return rpt
    End Function
