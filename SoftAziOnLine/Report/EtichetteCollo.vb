...
Public Class EtichetteCollo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteCollo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteCollo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteCollo = New EtichetteCollo()
        rpt.Site = Me.Site
        Return rpt
    End Function
