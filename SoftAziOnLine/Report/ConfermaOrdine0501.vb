...
Public Class ConfermaOrdine0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdine0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdine0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdine0501 = New ConfermaOrdine0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
