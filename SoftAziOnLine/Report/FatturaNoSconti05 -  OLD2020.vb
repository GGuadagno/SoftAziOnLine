...
Public Class FatturaNoSconti05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.FatturaNoSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFatturaNoSconti05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FatturaNoSconti05 = New FatturaNoSconti05
        rpt.Site = Me.Site
        Return rpt
    End Function
