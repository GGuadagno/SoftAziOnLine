...
Public Class OrdineNoSconti01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineNoSconti01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineNoSconti01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineNoSconti01 = New OrdineNoSconti01()
        rpt.Site = Me.Site
        Return rpt
    End Function
