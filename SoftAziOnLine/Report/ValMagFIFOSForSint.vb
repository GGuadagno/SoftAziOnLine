...
Public Class ValMagFIFOSForSint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValMagFIFOSForSint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValMagFIFOSForSint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValMagFIFOSForSint = New ValMagFIFOSForSint()
        rpt.Site = Me.Site
        Return rpt
    End Function
