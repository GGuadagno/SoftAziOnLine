...
Public Class Preventivo0501
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.Preventivo0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPreventivo0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Preventivo0501 = New Preventivo0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
