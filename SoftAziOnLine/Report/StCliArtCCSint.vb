...
Public Class StCliArtCCSint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.StCliArtCCSint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStCliArtCCSint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StCliArtCCSint = New StCliArtCCSint()
        rpt.Site = Me.Site
        Return rpt
    End Function
