...
Public Class FatturaNoSconti05LT
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FatturaNoSconti05LT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.FatturaNoSconti05LT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFatturaNoSconti05LT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FatturaNoSconti05LT = New FatturaNoSconti05LT()
        rpt.Site = Me.Site
        Return rpt
    End Function
