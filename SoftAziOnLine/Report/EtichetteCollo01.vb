...
Public Class EtichetteCollo01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.EtichetteCollo01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtichetteCollo01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtichetteCollo01 = New EtichetteCollo01()
        rpt.Site = Me.Site
        Return rpt
    End Function
