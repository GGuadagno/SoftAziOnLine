...
Public Class FatturaNoSconti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.FatturaNoSconti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFatturaNoSconti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FatturaNoSconti = New FatturaNoSconti()
        rpt.Site = Me.Site
        Return rpt
    End Function
