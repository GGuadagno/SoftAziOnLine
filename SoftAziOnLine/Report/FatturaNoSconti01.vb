...
Public Class FatturaNoSconti01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.FatturaNoSconti01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFatturaNoSconti01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FatturaNoSconti01 = New FatturaNoSconti01()
        rpt.Site = Me.Site
        Return rpt
    End Function
