...
Public Class AnagArticFornDESP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.AnagArticFornDESP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnagArticFornDESP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnagArticFornDESP = New AnagArticFornDESP()
        rpt.Site = Me.Site
        Return rpt
    End Function
