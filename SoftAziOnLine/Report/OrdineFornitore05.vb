...
Public Class OrdineFornitore05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.OrdineFornitore05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdineFornitore05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdineFornitore05 = New OrdineFornitore05()
        rpt.Site = Me.Site
        Return rpt
    End Function
