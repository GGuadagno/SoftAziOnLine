...
Public Class ConfermaOrdineNoSconti
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConfermaOrdineNoSconti.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdineNoSconti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdineNoSconti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdineNoSconti = New ConfermaOrdineNoSconti()
        rpt.Site = Me.Site
        Return rpt
    End Function
