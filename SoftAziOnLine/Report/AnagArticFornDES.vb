...
Public Class AnagArticFornDES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.AnagArticFornDES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnagArticFornDES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnagArticFornDES = New AnagArticFornDES()
        rpt.Site = Me.Site
        Return rpt
    End Function
