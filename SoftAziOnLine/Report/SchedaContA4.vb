...
Public Class SchedaContA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.SchedaContA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSchedaContA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SchedaContA4 = New SchedaContA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
