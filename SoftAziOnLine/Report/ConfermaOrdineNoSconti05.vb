...
Public Class ConfermaOrdineNoSconti05
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConfermaOrdineNoSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdineNoSconti05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdineNoSconti05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdineNoSconti05 = New ConfermaOrdineNoSconti05()
        rpt.Site = Me.Site
        Return rpt
    End Function
