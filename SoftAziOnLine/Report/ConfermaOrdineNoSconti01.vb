...
Public Class ConfermaOrdineNoSconti01
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConfermaOrdineNoSconti01.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ConfermaOrdineNoSconti01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConfermaOrdineNoSconti01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConfermaOrdineNoSconti01 = New ConfermaOrdineNoSconti01()
        rpt.Site = Me.Site
        Return rpt
    End Function
