...
Public Class ValMagFIFOSFor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValMagFIFOSFor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValMagFIFOSFor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValMagFIFOSFor = New ValMagFIFOSFor()
        rpt.Site = Me.Site
        Return rpt
    End Function
