...
Public Class NotaCredito05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.NotaCredito05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCredito05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCredito05 = New NotaCredito05()
        rpt.Site = Me.Site
        Return rpt
    End Function
