...
Public Class ElencoScadCAOrdCli05
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ElencoScadCAOrdCli05.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoScadCAOrdCli05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoScadCAOrdCli05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoScadCAOrdCli05 = New ElencoScadCAOrdCli05()
        rpt.Site = Me.Site
        Return rpt
    End Function
