...
Public Class ElencoCMRegCCliStato
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ElencoCMRegCCliStato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ElencoCMRegCCliStato.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedElencoCMRegCCliStato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ElencoCMRegCCliStato = New ElencoCMRegCCliStato()
        rpt.Site = Me.Site
        Return rpt
    End Function
