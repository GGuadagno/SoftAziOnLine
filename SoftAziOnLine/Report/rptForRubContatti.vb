...
Public Class rptForRubContatti
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.rptForRubContatti.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptForRubContatti
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptForRubContatti = New rptForRubContatti()
        rpt.Site = Me.Site
        Return rpt
    End Function
