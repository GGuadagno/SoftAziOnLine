...
Public Class VerbaleOACA05
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.VerbaleOACA05.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVerbaleOACA05
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VerbaleOACA05 = New VerbaleOACA05
        rpt.Site = Me.Site
        Return rpt
    End Function
