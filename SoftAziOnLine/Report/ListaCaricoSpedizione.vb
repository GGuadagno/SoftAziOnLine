...
Public Class ListaCaricoSpedizione
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListaCaricoSpedizione.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ListaCaricoSpedizione.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaCaricoSpedizione
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaCaricoSpedizione = New ListaCaricoSpedizione()
        rpt.Site = Me.Site
        Return rpt
    End Function
