...
Public Class FatturaNoSconti0501
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FatturaNoSconti0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.FatturaNoSconti0501.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFatturaNoSconti0501
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FatturaNoSconti0501 = New FatturaNoSconti0501()
        rpt.Site = Me.Site
        Return rpt
    End Function
