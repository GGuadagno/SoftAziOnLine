...
Public Class AnagArticAnalit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.AnagArticAnalit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnagArticAnalit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnagArticAnalit = New AnagArticAnalit()
        rpt.Site = Me.Site
        Return rpt
    End Function
