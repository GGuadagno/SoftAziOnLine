...
Public Class PrevClienteOrdineLS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrevClienteOrdineLS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.PrevClienteOrdineLS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrevClienteOrdineLS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrevClienteOrdineLS = New PrevClienteOrdineLS()
        rpt.Site = Me.Site
        Return rpt
    End Function
