...
Public Class ValMagMediaPond
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.ValMagMediaPond.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValMagMediaPond
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValMagMediaPond = New ValMagMediaPond()
        rpt.Site = Me.Site
        Return rpt
    End Function
