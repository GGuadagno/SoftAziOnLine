...
Public Class AnagArticFornCOD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SoftAziOnLine.AnagArticFornCOD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnagArticFornCOD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnagArticFornCOD = New AnagArticFornCOD()
        rpt.Site = Me.Site
        Return rpt
    End Function
