...
Partial Public Class WUC_StatVendCliArtAG
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) Then
            ...
            If Request.QueryString("labelForm") = "Venduto/Fatturato per articolo/cliente per agente" Then
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        Dim CodAgente As Integer 'alberto 16/05/2012
        ...
        If rbtnCliente.Checked Then
            Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoClienteArticoloAG  '1 ORDINATO PER CLIENTE / ARTICOLO
        Else
            Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoArticoloClienteAG  '2 ORDINATO PER ARTICOLO / CLIENTE 
        End If
        ...
        Try
            If ClsPrint.StampaStatisticheVendutoArticoloClienteAG(txtCodArt1.Text, txtCodArt2.Text, txtCodCliente.Text, txtDataDa.Text, txtDataA.Text, txtNCData.Text, Session(CSTSTATISTICHE), Statistica, VisualizzaPrezzoVendita, Session(CSTAZIENDARPT), DsStatVendCliArt1, ObjReport, StrErrore, CodAgente) Then
