<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_ElencoEmail.ascx.vb" Inherits="SoftAziOnLine.WUC_ElencoEmail" %>
                ...
                <asp:UpdatePanel ID="UpdatePanelDett" runat="server"><ContentTemplate>
                    <div id="divGridViewPrevT" style="overflow:auto; width:950px; height:300px; border-style:groove;">
                      <asp:GridView ID="GridViewPrevT" runat="server" AutoGenerateColumns="False" 
                            ...
                            EnableTheming="True" GridLines="None" DataSourceID="" BackColor="Silver" AllowSorting="true" PagerSettings-Position="Bottom">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="DesStato" HeaderText="Stato" 
                                    SortExpression="DesStato">
                                    <HeaderStyle Width="10px"/><ItemStyle Width="10px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="DataInvio" HeaderText="Data Invio" 
                                    SortExpression="DataInvio">
                                    <HeaderStyle Width="10px"/><ItemStyle Width="10px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="NEmail" HeaderText="N°" 
                                    SortExpression="NEmail">
