...
Partial Public Class WUC_CambiaStatoCA
...
#Region "Metodi public"
    ...
    Public Function AggiornaDati() As Boolean
        ...
        If rbtnNonCompleto.Checked Then myStatoDoc = 5
        If rbtnEvaso.Checked Or rbtnDaEvadere.Checked Or rbtnParzEvaso.Checked Or rbtnNonCompleto.Checked Then
            SWChiuso = False
        ...
        Try
            StrSql = "Update ContrattiT Set StatoDoc=" & myStatoDoc & _
            ...
            ClsDBUt.ExecuteQueryUpdate(TipoDB.dbScadenzario, StrSql)
            AggiornaDati = True
    ...
    Private Function CKRefInt(ByRef _strErrore As String) As Boolean
        ...
        _strErrore = ""
        Dim strSQL As String = ""
        strSQL = "Select TOP 1 IDDocumenti From ContrattiT Where RefInt = " & Session(IDDOCUMENTI)
