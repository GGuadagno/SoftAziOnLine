<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_ElencoPreventivi.ascx.vb" Inherits="SoftAziOnLine.WUC_ElencoPreventivi" %>
...
<table border="0" cellpadding="0" frame="box" style="width:auto; height:550px; margin-right:0;">
                ...
                <td  width ="100%" align="left" colspan="2" >
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp;<asp:TextBox ID="txtRicerca" runat="server" Width="200px"></asp:TextBox>&nbsp;<asp:Button ID="btnRicerca" runat="server" Text="Cerca preventivo" class="btnstyle1RL" />
            ...
            <tr>
                ...
                <div id="divGridViewPrevT" style="overflow:auto; width:1110px; height:195px; border-style:groove;">
                        ...
                        <asp:SqlDataSource ID="SqlDSPrevTElenco" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:SessionParameter DefaultValue="PR" Name="TipoDoc" SessionField="TipoDoc" Type="String" />
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                <div id="divGridViewPrevD" style="overflow-x:hidden; overflow-y:hidden; width:1110px; height:230px; border-style:groove;">
