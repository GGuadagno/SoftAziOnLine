...
Partial Public Class WUC_StatVendForArt
    Inherits System.Web.UI.UserControl

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnControllo.Text = "Stampa di controllo"
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoForArt
        ...
        Try
            If ClsPrint.StampaStatisticheVendutoFornitoreArticolo(txtCod1.Text, txtCod2.Text, txtCodFornitore.Text, txtDataDa.Text, txtDataA.Text, txtNCData.Text, Statistica, Session(CSTAZIENDARPT), DsStatVendCliArt1, ObjReport, StrErrore) Then
    ...
    Private Sub btnControllo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnControllo.Click
        ...
        Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoForArtCli
