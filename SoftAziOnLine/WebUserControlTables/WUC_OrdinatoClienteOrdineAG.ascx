<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_OrdinatoClienteOrdineAG.ascx.vb" Inherits="SoftAziOnLine.WUC_OrdinatoClienteOrdineAG" %>
...
<table style="vertical-align:middle; background-color:Silver; border-style:double; height: 338px; width: 927px;" >
                <td class="style1">
                    ...
                    <asp:Panel ID="PanelSelezione" style="margin-top: 0px;" runat="server" groupingtext="Selezione cliente" Height="113px" 
                        Width="859px">
                      ...
                      <asp:Panel ID="PanelTipoStampa" style="margin-top: 0px;" runat="server" groupingtext="Selezione tipo riepilogo" Height="101px" Width="859px">
                        ...
                        <asp:Panel ID="PanelOrdinamento" style="margin-top: 0px;" runat="server" groupingtext="Selezione ordinamento" Height="99px" 
                        Width="859px">
                            <br />
