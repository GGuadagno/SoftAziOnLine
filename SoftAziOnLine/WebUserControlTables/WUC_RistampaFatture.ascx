<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_RistampaFatture.ascx.vb" Inherits="SoftAziOnLine.WUC_RistampaFatture" %>
                    ...
                    <table style="width: 960px">
                        <tr>
                            <td style="width:300px" align="right" >
                                ...
                                Text="Seleziona tutte le fatture fino alla data" ></asp:Label>&nbsp;
                            </td> 
                        ...
                        <tr>
                            <td style="width:300px" align="right">
                                &nbsp;<asp:Label ID="Label4" runat="server" BorderColor="White"
                                    ...
                                    BorderStyle="None" Font-Bold="false" ForeColor="Black" 
                                    Text="Alla Fattura" ></asp:Label>
                            </td> 
                            <td style="width:150px">
                                <div>
                                    <asp:TextBox ID="txtAlN" runat="server" MaxLength="10" TabIndex="3" Width="70px"></asp:TextBox>
                                    <asp:Button ID="btnCercaNum" runat="server" CausesValidation="False" Text="Cerca" />
                                </div>
                            </td>
                            <td style="width:400px">
                                <div>
            ...
            <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    ...
                    <div id="divGridViewPrevT" style="overflow:auto; width:860px; height:195px; border-style:groove;">
                        ...
                        <asp:SqlDataSource ID="SqlDSPrevTElenco" runat="server" 
                            SelectCommand="get_DocTElencoFattureStampa" 
                            SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter DefaultValue="Z" Name="CodArtSel" SessionField="CodArtSel" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </div>
                    </ContentTemplate>
                ...
                <td align="left">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div>
                                <asp:Button ID="btnStampaTutte" runat="server" class="btnstyle" Text="Stampa tutte" />
                            </div>
                            <div style="height: 15px">
                            </div>
                            <div>
                                <asp:Button ID="btnStampaFattura" runat="server" class="btnstyle" Text="Singola Fattura"/>
                            </div>
                            <div style="height: 15px">
                            </div>
                            <div style="height: 40px">
                                <asp:CheckBox ID="chkFatturaPA" runat="server" Text="Seleziona Fatture PA" Checked="false" AutoPostBack="true" Font-Bold="true"/>
                            </div>
                            <div style="height: 15px">
                            </div>
                            <div style="height: 40px">
