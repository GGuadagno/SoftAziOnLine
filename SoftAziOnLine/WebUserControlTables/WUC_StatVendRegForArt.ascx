<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_StatVendRegForArt.ascx.vb" Inherits="SoftAziOnLine.WUC_StatVendRegForArt" %>
...
<table style="vertical-align:middle; background-color:Silver; border-style:double; height: 260px; width: 927px;" >
            <tr>
                <td>
                    <asp:Panel ID="PanelSelezionaRegione" style="margin-top: 0px;" runat="server" GroupingText="Regioni">
                    <table width="100%">
                        <tr>
                            <td align="left">Singola regione</td><td>
                            <asp:DropDownList ID="ddlRegioni" runat="server" DataSourceID="SqlDa_Regioni" 
                    ...
                    <asp:Label ID="lblDallaData" runat="server" Height="16px" Width="100px">Dalla data</asp:Label>
                            ...
                            <asp:ImageButton ID="imgBtnShowCalendarDa" runat="server" ImageUrl="~/Immagini/Icone/Calendar_scheduleHS.png" ToolTip="apri il calendario" TabIndex="2" CausesValidation="False" />
                            ...
                            &nbsp;<asp:Label ID="lblAllaData" runat="server" Height="20px" Width="66px">Alla data</asp:Label><asp:TextBox ID="txtDataA" runat="server" Width="80px" MaxLength="10" AutoPostBack="true" TabIndex="3"></asp:TextBox><asp:ImageButton ID="imgBtnShowCalendarA" runat="server" ImageUrl="~/Immagini/Icone/Calendar_scheduleHS.png" ToolTip="apri il calendario" TabIndex="4" CausesValidation="False" />
                            ...
                            ValidationExpression="(((0[1-9]|[12][0-9]|3[01])([/])(0[13578]|10|12)([/])(\d{4}))|(([0][1-9]|[12][0-9]|30)([/])(0[469]|11)([/])(\d{4}))|((0[1-9]|1[0-9]|2[0-8])([/])(02)([/])(\d{4}))|((29)(\.|-|\/)(02)([/])([02468][048]00))|((29)([/])(02)([/])([13579][26]00))|((29)([/])(02)([/])([0-9][0-9][0][48]))|((29)([/])(02)([/])([0-9][0-9][2468][048]))|((29)([/])(02)([/])([0-9][0-9][13579][26])))" />
                            &nbsp;&nbsp;<asp:Label ID="lblDataNC" runat="server" Height="20px" >N.C. alla data</asp:Label><asp:TextBox ID="txtNCData" runat="server" Width="80px" MaxLength="10" TabIndex="5"></asp:TextBox><asp:ImageButton ID="imgBtnShowCalendarNC" runat="server" ImageUrl="~/Immagini/Icone/Calendar_scheduleHS.png" ToolTip="apri il calendario" TabIndex="6" CausesValidation="False" />
                     ...
                     <asp:Panel ID="Panel" runat="server" groupingtext="Fornitori" style="margin-top: 0px;" Height="78px" Width="859px">
                            ...
                            &nbsp;&nbsp;<asp:TextBox ID="txtCodFornitore" runat="server"  Width="100px" MaxLength="16" AutoPostBack="True" TabIndex="6" ></asp:TextBox>&nbsp;&nbsp;<asp:TextBox ID="txtDescFornitore" runat="server" Width="400px" MaxLength="50" TabIndex="7" Enabled="False"  ></asp:TextBox><br>
                    ...
                    <asp:Panel ID="PanelArticolo" runat="server" groupingtext="Articoli" style="margin-top: 0px;" Height="105px" Width="859px">
                            ...
                            &nbsp;&nbsp;<asp:TextBox ID="txtCod1" runat="server"  Width="100px" MaxLength="20" AutoPostBack="True" TabIndex="10" ></asp:TextBox>&nbsp;&nbsp;<asp:TextBox ID="txtDesc1" runat="server" Width="400px" MaxLength="150" TabIndex="11" Enabled="False"  ></asp:TextBox><br>
                            ...
                            &nbsp;&nbsp;<asp:TextBox ID="txtCod2" runat="server"  Width="100px" MaxLength="20" TabIndex="12" AutoPostBack="True" ></asp:TextBox>&nbsp;&nbsp;<asp:TextBox ID="txtDesc2" runat="server" Width="400px" MaxLength="150" TabIndex="13" Enabled="False"  ></asp:TextBox><br>
                    ...
                    <td align="left" class="style7">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                 <div>
                                    <asp:Button ID="btnStampa" runat="server" class="btnstyle" Text="Stampa" TabIndex="21" CausesValidation="False" />
                                </div>
                                <div style="height: 15px">
                                </div>
                                <div>
                                    <asp:Button ID="btnControllo" runat="server" class="btnstyleDoppio" Text="Controllo" TabIndex="21" CausesValidation="False" />
                                </div>
                                <div style="height: 15px">
                                </div>
                                <div>
                                    <asp:Button ID="btnAnnulla" runat="server" class="btnstyle" Text="Annulla" TabIndex="22" CausesValidation="False" />
                                </div>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
