...
Partial Public Class WUC_StatVendCliArtCategSintetico
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        If rbtnCliente.Checked Then
            Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoArticoloClienteCCSintetico  'E' indifferente
        Else
            Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoArticoloClienteCCSintetico
        End If
