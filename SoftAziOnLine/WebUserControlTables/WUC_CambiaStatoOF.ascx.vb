...
#Region "Metodi public"
    ...
    Public Function AggiornaDati() As Boolean
        ...
        If rbtnInCarico.Checked Then myStatoDoc = 5
        If rbtnEvaso.Checked Or rbtnDaEvadere.Checked Or rbtnParzEvaso.Checked Or rbtnInCarico.Checked Then
            SWChiuso = False
    ...
    Private Function CKRefInt(ByRef _strErrore As String) As Boolean
        ...
        _strErrore = ""
        Dim strSQL As String = ""
        strSQL = "Select TOP 1 IDDocumenti From DocumentiT Where RefInt = " & Session(IDDOCUMENTI)
