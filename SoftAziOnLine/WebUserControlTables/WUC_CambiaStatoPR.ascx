<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CambiaStatoPR.ascx.vb" Inherits="SoftAziOnLine.WUC_CambiaStatoPR" %>
        ...
        <td >
            ...
            <asp:Panel ID="PanelBody" runat="server" Height="300px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                ...
                <div style="text-align:left">
                    ...
                    <asp:RadioButton ID="rbtnEvaso" runat="server" Text="Confermato" AutoPostBack="false" 
                        GroupName="Tipo" />
                    <asp:Label ID="Label0" runat="server" Width="10px">&nbsp;</asp:Label>
                    <asp:RadioButton ID="rbtnDaEvadere" runat="server" Text="Da confermare" 
                        AutoPostBack="false" GroupName="Tipo" />
                    <asp:Label ID="Label3" runat="server" Width="10px" Visible="false">&nbsp;</asp:Label>
                    <asp:RadioButton ID="rbtnParzEvaso" runat="server" Text="Parzialmente confermato" 
                        AutoPostBack="false" GroupName="Tipo" Visible="false"/>
                    <asp:Label ID="Label4" runat="server" Width="10px">&nbsp;</asp:Label>
                    <asp:RadioButton ID="rbtnChiusoNoEvaso" runat="server" Text="Chiuso non confermato" 
                        AutoPostBack="false" GroupName="Tipo" />
                    <asp:Label ID="Label5" runat="server" Width="10px">&nbsp;</asp:Label>
                    <asp:RadioButton ID="rbtnNonEvadibile" runat="server" Text="Non confermabile" 
                        AutoPostBack="false" GroupName="Tipo" />
                    ...
                    <asp:RadioButton ID="rbtnInAllestimento" runat="server" Text="In Allestimento" 
                        AutoPostBack="false" GroupName="Tipo" Enabled="false" Visible="false"/>
                </div>
                <br /> 
                <div style="text-align:left">
                    &nbsp;<asp:Label ID="Label6" 
