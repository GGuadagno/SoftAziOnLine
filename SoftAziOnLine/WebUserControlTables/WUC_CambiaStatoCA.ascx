<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CambiaStatoCA.ascx.vb" Inherits="SoftAziOnLine.WUC_CambiaStatoCA" %>
            ...
            <asp:Panel ID="PanelBody" runat="server" Height="300px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                ...
                <div style="text-align:left">
                    ...
                    <asp:RadioButton ID="rbtnParzEvaso" runat="server" Text="Parzialmente evaso" 
                        AutoPostBack="false" GroupName="Tipo" />
                    <asp:Label ID="Label8" runat="server" Width="10px">&nbsp;</asp:Label>
                    <asp:RadioButton ID="rbtnNonCompleto" runat="server" Text="Non completo" 
                        AutoPostBack="false" GroupName="Tipo" ForeColor="DarkRed" />
