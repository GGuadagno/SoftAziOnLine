...
Partial Public Class WUC_StatVendRegCatArt
    Inherits System.Web.UI.UserControl

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim dbCon As New dbStringaConnesioneFacade(Session(ESERCIZIO))
        SqlDa_Regioni.ConnectionString = dbCon.getConnectionString(TipoDB.dbSoftAzi)
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoRegioneCateg
        ...
        Try
            If cbSintetico.Checked = False Then
                Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoRegioneCateg
                If ClsPrint.StampaStatisticheVendutoRegioneCatArt(txtCod1.Text, txtCod2.Text, CodCateg, txtDataDa.Text, txtDataA.Text, txtNCData.Text, Statistica, Session(CSTAZIENDARPT), DsStatVendCliArt1, ObjReport, StrErrore, CodRegione, False) Then
                ...
                End If
            Else
                Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoRegioneCategSintetico
                If ClsPrint.StampaStatisticheVendutoRegioneCatArt(txtCod1.Text, txtCod2.Text, CodCateg, txtDataDa.Text, txtDataA.Text, txtNCData.Text, Statistica, Session(CSTAZIENDARPT), DsStatVendCliArt1, ObjReport, StrErrore, CodRegione, True) Then
                    If DsStatVendCliArt1.StCliArt.Count > 0 Then
                        Session(CSTObjReport) = ObjReport
                        Session(CSTDSStatVendCliArt) = DsStatVendCliArt1
                        Session(CSTNOBACK) = 0 'giu040512
