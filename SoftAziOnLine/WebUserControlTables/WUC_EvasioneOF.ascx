<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_EvasioneOF.ascx.vb" Inherits="SoftAziOnLine.WUC_EvasioneOF" %>
            ...
            <asp:Panel ID="PanelBody" runat="server" Height="300px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                <asp:GridView ID="GridViewDocD" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-Width="10px" HeaderText="Quantità da caricare">
                            <ItemTemplate>
