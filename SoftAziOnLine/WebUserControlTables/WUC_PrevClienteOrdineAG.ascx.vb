...
Partial Public Class WUC_PrevClienteOrdineAG
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        If PanelSelezionaAgente.Visible = True Then
            ...
            arrFormDati.Add(RkFormDati)
            '- non serve e poi il test non va bene ... si voleva obbligare a selezionare l'agente nel caso di stampa analitica
            ' ''If rbtnAnalitico.Checked And chkTuttiFornitori.Checked = True And chkTuttiArticoli.Checked = True Then
            ' ''    If ddlAgenti.SelectedValue < 1 Then
            ' ''        StrErrore = StrErrore & "<BR>- Stampa Analitica: Selezionare l'Agente."
            ' ''        ErroreCampi = True
            ' ''    End If
            ' ''End If
        Else
            ...
            arrFormDati.Add(RkFormDati)
            '- non serve e poi il test non va bene ... si voleva obbligare a selezionare lead source nel caso di stampa analitica
            ' ''If rbtnAnalitico.Checked And chkTuttiFornitori.Checked = True And chkTuttiArticoli.Checked = True Then
            ' ''    If DDLLead.SelectedValue < 1 Then
            ' ''        StrErrore = StrErrore & "<BR>- Stampa Analitica: Selezionare Lead Source."
            ' ''        ErroreCampi = True
            ' ''    End If
            ' ''End If
        End If
            ...
            If PanelSelezionaAgente.Visible = True Then
                ...
                If PanelOrdinamento.Visible = True Then
                    If rbtOrdAgCliPrev.Checked = True Then
                        Session(CSTORDINATO) = TIPOSTAMPAORDINATO.PrevClienteOrdineAG 'giu050722 ordinamento di default
                        TitoloRpt = "Preventivi per Agente/cliente/preventivo"
                    Else
                        Session(CSTORDINATO) = TIPOSTAMPAORDINATO.PrevOrdineClienteAG
