...
Partial Public Class WUC_StatVendRegForArt
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        If Not IsDate(txtDataDa.Text) Or Not IsDate(txtDataA.Text) Then
            StrErroreCampi = StrErroreCampi & "<BR>- data inizio/fine periodo errata"
            ErroreCampi = True
        End If
        ...
        If txtDataA.Text <> "" And txtNCData.Text <> "" Then
            If Not IsDate(txtNCData.Text) Then
                StrErroreCampi = StrErroreCampi & "<BR>- data fine periodo NC errata"
                ErroreCampi = True
            End If
        ...
        Session(CSTSTATISTICHE) = TIPOSTAMPASTATISTICA.VendutoRegFortArt
        ...
        End If
        Try
            If ClsPrint.StampaStatisticheVendutoRegioneForArt(txtCod1.Text, txtCod2.Text, txtCodFornitore.Text, txtDataDa.Text, txtDataA.Text, txtNCData.Text, Statistica, Session(CSTAZIENDARPT), DsStatVendCliArt1, ObjReport, StrErrore, CodRegione) Then
