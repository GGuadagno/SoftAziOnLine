...
Partial Public Class WUC_OrdinatoPerArticoloAG
    ...
    Private Sub btnStampa_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnStampa.Click
        ...
        Dim CodAgente As Integer = 0 'alberto 14/05/2012
        ...
        Try
            ...
            If txtDataDa.Text <> "" Or txtDataA.Text <> "" Then
                Session(CSTORDINATO) = TIPOSTAMPAORDINATO.OrdinatoArticoloDataAg
            Else
                Session(CSTORDINATO) = TIPOSTAMPAORDINATO.OrdinatoArticoloAg
            End If
            If rbtnCodice.Checked Then
            ...
            If ClsPrint.StampaOrdinatoArticoloAG(Session(CSTORDINATO), txtCod1.Text, txtCod2.Text, txtDesc1.Text, txtDesc2.Text, txtDataDa.Text, txtDataA.Text, Session(CSTAZIENDARPT), Ordinamento, DSOrdinatoArticolo1, ObjReport, StrErrore, CodAgente) Then
                If DSOrdinatoArticolo1.OrdinatoPerArticolo.Rows.Count = 0 And DSOrdinatoArticolo1.OrdinatoPerArticoloData.Rows.Count = 0 Then
                    Session(MODALPOPUP_CALLBACK_METHOD) = ""
                    Session(MODALPOPUP_CALLBACK_METHOD_NO) = ""
