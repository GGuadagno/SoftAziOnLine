<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_ClientiOCPregr.ascx.vb" Inherits="SoftAziOnLine.WUC_ClientiOCPregr" %>
    ...
    <table border="0" cellpadding="0" frame="box" style="width:1205px; height:500px; margin-right:0;">
            ...
            <td width ="1205px" style="height:40px" align="left" colspan="2" >
                    ...
                    <tr>
                        <td>
                            ...
                            &nbsp;<asp:Button ID="btnRicerca" runat="server" Text="Cerca Ordine"/>
                            &nbsp;<asp:Button ID="btnFatturaOC" runat="server" Text="Em.Fattura"/>
                            &nbsp;<asp:Button ID="btnFatturaOCAC" runat="server" Text="Em.Fattura Acc./Saldo"/>
                            &nbsp;<asp:Button ID="btnDocCollegati" runat="server" Text="Documenti Collegati"/>
                            &nbsp;<asp:Button ID="btnCambiaStato" runat="server" Text="Cambia stato Ordine"/>
                        </td>
                    </tr>
                    </table> 
            </td>
        ...
        <tr>
            <td width ="1080px" align="left">
                ...
                <div>
                    ...
                    <asp:RadioButton ID="rbntInAllestimento" runat="server" Text="In Allestimento" 
                        AutoPostBack="True" GroupName="Tipo" />
                    <asp:Label ID="Label10" runat="server" Width="10px">&nbsp;</asp:Label>  
            ...
            <td align="left" class="style9">
                ...
                <div>
                    <asp:Button ID="btnSblocca" runat="server" class="btnstyle2R" Text="Sblocca Documento" Visible="false" />
                </div>
            </td>
        </tr>
        <tr>
            <td width ="1080px" align="left">
            <div id="divGridViewOrdT" style="overflow:auto; width:1080px; height:180px; border-style:groove;">                
                    <asp:GridView ID="GridViewOrdT" runat="server" AutoGenerateColumns="False" 
                        ...
                        DataSourceID="SqlDSOrdTElenco" BackColor="Silver" AllowSorting="True">
                    ...
                    <asp:SqlDataSource ID="SqlDSOrdTElenco" runat="server" 
                        SelectCommand="get_OrdiniTElenco" 
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="OC" Name="TipoDoc" SessionField="TipoDocOC" Type="String" />
                            <asp:SessionParameter DefaultValue="0" Name="StatoDoc" SessionField="StatoDocOC" Type="Int32" />
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
               <div id="divGridViewPrevD" style="overflow-x:hidden; overflow-y:hidden; width:1080px; height:170px; border-style:groove;">                
                    <asp:GridView ID="GridViewPrevD" runat="server" AutoGenerateColumns="False" 
                        ...
                        <ItemStyle Width="40px" Wrap="false" /></asp:BoundField>
                    ...
                    <asp:SqlDataSource ID="SqlDSPrevDByIDDocumenti" runat="server" 
                        ...
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="0" Name="IDDocumenti" SessionField="IDDocOCCli" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
            </div>
            </ContentTemplate>
            ...
            <td align="left" class="styleh170">
                ...
                <div style="height: 5px">&nbsp;</div>
                <div>
                    <asp:Button ID="btnConfOrdine" runat="server" class="btnstyle2R" Text="Stampa Conf.Ordine" />
                </div>
                <div style="height: 5px">&nbsp;</div>
                <div>
                    <asp:Button ID="btnStampa" runat="server" class="btnstyle2R" Text="Stampa Ordine" />
                </div>
                <div style="height: 5px">&nbsp;</div>
                <div>
