<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_Magazzini.ascx.vb" Inherits="SoftAziOnLine.WUC_Magazzini" %>
        ...
        <td class="style1" >
            ...
            <table style="width: 680px"> 
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlMagazzini" runat="server" AppendDataBoundItems="True" 
                            AutoPostBack="True" Width="100%"
                            DataSourceID="SqlDSMagazzini" DataTextField="Descrizione" 
                            DataValueField="Codice" Height="22px"><asp:ListItem Text="" Value=""></asp:ListItem></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDSMagazzini" runat="server" 
                            SelectCommand="SELECT Codice, Descrizione FROM Magazzini ORDER BY Descrizione" SelectCommandType="Text" 
                            UpdateCommand="InsertUpdate_Magazzini" 
