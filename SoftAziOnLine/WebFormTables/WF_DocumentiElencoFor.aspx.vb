...
Partial Public Class WF_DocumentiElencoFor
    ...
    '    End Try
    'End Sub
    Private Sub WF_DocumentiElencoFor_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not IsPostBack) Then
            ...
            End If
            If SWRbtnTD = "" Then
                Session(CSTSWRbtnTD) = SWTD(TD.DocTrasportoFornitori)
            End If
        End If
    End Sub
End Class