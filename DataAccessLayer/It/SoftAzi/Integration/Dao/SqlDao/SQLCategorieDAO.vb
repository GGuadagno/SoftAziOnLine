...
Namespace It.SoftAzi.Integration.Dao.SQLDao
    Public Class SQLCategorieDAO
        Inherits SQLBaseDAO
        Implements It.SoftAzi.Integration.Dao.CategorieDAO

        Public Function getCategorie(ByVal idTransazione As Integer) As System.Collections.ArrayList Implements CategorieDAO.getCategorie
            Dim theSqlCommand As SqlCommand
            Dim param As SqlParameter = Nothing
            Dim theSqlDataReader As SqlDataReader = Nothing
            Dim myCategorie As CategorieEntity
            ...
            Try
                ...
                theSqlCommand.CommandText = "get_Categorie"
                ...
                Try
                    ...
                    If theError = 0 Then
                        ...
                        While (theSqlDataReader.Read())
                            myCategorie = New CategorieEntity
                            With myCategorie
                                .Codice = getIntegerParameter(theSqlDataReader, 0)
                                .Descrizione = getStringParameter(theSqlDataReader, 1)
                                .InvioMailSc = getBooleanParameter(theSqlDataReader, 2)
                                .SelSc = getBooleanParameter(theSqlDataReader, 3)
                            End With
