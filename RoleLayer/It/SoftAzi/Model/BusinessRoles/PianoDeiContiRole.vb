    ...
    Public Class PianoDeiContiRole
        Public Function getPianoDeiConti() As ArrayList
            ...
            Try
                ...
                myPianoDeiConti = myFactory.getPianoDeiConti
                myIdTransazione = myDataSource.beginTransaction(DataSource.TipoConnessione.dbSoftCoge)
                ptrns = myPianoDeiConti.getPianoDeiConti(myIdTransazione)
