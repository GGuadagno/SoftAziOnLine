<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_TipoCodArt.ascx.vb" Inherits="SoftAziOnLine.WFP_TipoCodArt" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_TipoCodArt.ascx" TagName="WUCTipoCodArt" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <wuc:WUCTipoCodArt ID="WUC_TipoCodArt" runat="server" />
    </asp:Panel>
