<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_SceltaListiniDaAggiornare.ascx.vb" Inherits="SoftAziOnLine.WUC_SceltaListiniDaAggiornare" %>
...
<table style="width:auto;height:auto;">
    <tr>
        <td >
            ...
            <asp:Panel ID="PanelDescEstesa" runat="server" Height="100px" ScrollBars="Vertical" BorderStyle="Solid" BorderWidth="1px">
                <asp:GridView ID="GridViewBody" runat="server" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Data_Inizio_Validita" HeaderText="Data_Inizio_Validita" SortExpression="Data inizio validita" />
                        ...
                        <asp:BoundField DataField="Cod_Pagamento" HeaderText="Cod_Pagamento" SortExpression="Codice pagamento" />
