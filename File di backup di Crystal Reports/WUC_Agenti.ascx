<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_Agenti.ascx.vb" Inherits="SoftAziOnLine.WUC_Agenti" %>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:SqlDataSource ID="SqlDSAgenti" runat="server" 
                            SelectCommand="SELECT * FROM [Agenti] ORDER BY [Descrizione]" 
                            UpdateCommand="InsertUpdate_Agenti" 
                            ...
                            <UpdateParameters>
                                ...
                                <asp:Parameter Name="CodCapogruppo" Type="Int32" />
                            </UpdateParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
