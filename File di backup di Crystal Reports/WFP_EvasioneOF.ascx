<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_EvasioneOF.ascx.vb" Inherits="SoftAziOnLine.WFP_EvasioneOF" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_EvasioneOF.ascx" TagName="EvasioneOF" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="CARICO PARZIALE ORDINE FORNITORE" Width="99%"></asp:Label>
        <wuc:EvasioneOF ID="WUCEvasioneOF" runat="server" />
    </asp:Panel>
    ...
    <div style="text-align:center;">    
        <asp:Button ID="btnOk" runat="server" Text="OK Carico di magazzino" OnClick="btnOk_Click" />
