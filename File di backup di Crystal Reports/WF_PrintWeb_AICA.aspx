<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WF_PrintWeb_AICA.aspx.vb" Inherits="SoftAziOnLine.WF_PrintWeb_AICA" %>
...
<body onload="javascript:window.history.forward(1);">
    ...
    <td>
        ...
        &nbsp;<asp:Label ID="lblMessaggi" runat="server" Font-Bold="True" Font-Size="Large" 
