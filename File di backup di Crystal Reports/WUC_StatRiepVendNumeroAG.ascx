<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_StatRiepVendNumeroAG.ascx.vb" Inherits="SoftAziOnLine.WUC_StatRiepVendNumeroAG" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <uc1:ModalPopup ID="ModalPopup" runat="server" />
        ...
        <table style="vertical-align:middle; background-color:Silver; border-style:double; height: 206px; width: 708px;">
            <tr>
                <td class="style8">
                    <asp:Panel ID="Panel1" runat="server" GroupingText="Agente" 
                        style="margin-top: 0px;" Width="572px" heigth="66px">                        
                        
                        <table width="100%">
                        <tr>
                            <td align="left" class="style2">Singolo agente</td><td>
                            <asp:DropDownList ID="ddlAgenti" runat="server" DataSourceID="SqlDa_Agenti" 
                                DataTextField="Descrizione" DataValueField="Codice" Width="250px" 
                    ...
                    <asp:Panel ID="PanelTipoStatistica" style="margin-top: 0px;" runat="server" groupingtext="Statistica" Width="572px">
                        ...
                        <tr>
                            ...
                            AutoPostBack="True" GroupName="TipoStatistica" TabIndex="14" />
                            </td>
                            <td width ="33%">
                            <asp:RadioButton ID="rbtnFatturato" runat="server" Text="Fatturato" AutoPostBack="True" 
                            GroupName="TipoStatistica" TabIndex="15" />
                            </td>
                            <td width="34%">
                            <asp:RadioButton ID="rbtnDaFatturare" runat="server" Text="Da Fatturare" 
                            AutoPostBack="True" GroupName="TipoStatistica" TabIndex="16" />
                            </td>
                        </tr>
                        </table>
                    </asp:Panel>
