<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_Articolo_SelezSing.ascx.vb" Inherits="SoftAziOnLine.WFP_Articolo_SelezSing" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        ...
        <ContentTemplate>
            ...
            <asp:CheckBox ID="checkParoleContenute" runat="server" Text="Parole contenute" Checked="false"/>&nbsp
                        ...
                        <table style="width:100%;">
                            <tr><td>
                                <div id="divGridViewArtIn" 
                                    style="overflow: auto; height:430px; border-style:groove; background-color: Silver;">
