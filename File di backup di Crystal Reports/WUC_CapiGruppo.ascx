<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CapiGruppo.ascx.vb" Inherits="SoftAziOnLine.WUC_CapiGruppo" %>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:SqlDataSource ID="SqlDSCapiGruppo" runat="server" 
                            ...
                            UpdateCommand="InsertUpdate_CapiGruppo" 
