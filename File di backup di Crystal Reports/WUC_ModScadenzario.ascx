<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_ModScadenzario.ascx.vb" Inherits="SoftAziOnLine.WUC_ModScadenzario" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <uc1:ModalPopup ID="ModalPopup" runat="server" />
        ...
        <table style="vertical-align:middle; background-color:Silver; border-style:double; height: 206px; width: 708px;">
            <tr>
                <td>
                    <asp:Panel ID="PanelSelezionaDate" runat="server" GroupingText="MODIFICA ELENCO SCADENZE CONTRATTI PER AGGIUNTA CAMPO TOTALE FATTURATO/RESIDUO" 
