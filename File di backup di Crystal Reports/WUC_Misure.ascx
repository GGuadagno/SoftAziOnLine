<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_Misure.ascx.vb" Inherits="SoftAziOnLine.WUC_Misure" %>
        ...
        <td class="style1" >
            ...
            <table style="width: 680px"> 
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlMisure" runat="server" AppendDataBoundItems="True" 
                            AutoPostBack="True" Width="100%"
                            DataSourceID="SqlDSMisure" DataTextField="Descrizione" 
                            DataValueField="Codice" Height="22px"><asp:ListItem Text="" Value=""></asp:ListItem></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDSMisure" runat="server" 
                            SelectCommand="SELECT * FROM [Misure] ORDER BY [Descrizione]" 
                            UpdateCommand="InsertUpdate_Misure" 
                ...
                <tr>
                    ...
                    <td colspan="3" style="margin-left: 120px">
                        <asp:TextBox ID="txtDescrizione" AutoPostBack="true" runat="server" Width="100%" 
