<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_FatturaOC.ascx.vb" Inherits="SoftAziOnLine.WFP_FatturaOC" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_FatturaOC.ascx" TagName="FatturaOC" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="FATTURA PARZIALE ORDINE CLIENTE" Width="99%"></asp:Label>
        <wuc:FatturaOC ID="WUCFatturaOC" runat="server" />
    </asp:Panel>
