<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CategorieArt.ascx.vb" Inherits="SoftAziOnLine.WUC_CategorieArt" %>
    ...
    <tr>
        <td class="style1" >
            ...
            <table style="width: 680px"> 
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlCategorie" runat="server" AppendDataBoundItems="True" 
                            ...
                            DataSourceID="SqlDSCategorieArt" DataTextField="Descrizione" 
                            DataValueField="Codice" Height="22px"><asp:ListItem Text="" Value=""></asp:ListItem></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDSCategorieArt" runat="server" 
                            SelectCommand="SELECT * FROM [CategArt] ORDER BY [Descrizione]" 
                            UpdateCommand="InsertUpdate_CategorieArt" 
                            UpdateCommandType="StoredProcedure">
                            <UpdateParameters>
                                <asp:Parameter Direction="ReturnValue" Name="RETURN_VALUE" Type="String" />
                                <asp:Parameter Name="Codice" Type="String" />
                                <asp:Parameter Name="Descrizione" Type="String" />
                                <asp:Parameter Name="ContoRicavo" Type="String" />
                            </UpdateParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="left" class="style2">Conto ricavo</td>
                    <td colspan="3" style="margin-left: 120px">
                        <asp:TextBox ID="TxtContoRicavo" AutoPostBack="true" runat="server" Width="99%" 
