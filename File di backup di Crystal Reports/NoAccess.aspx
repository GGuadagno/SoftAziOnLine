<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NoAccess.aspx.vb" Inherits="SoftAziOnLine.NoAccess" %>
...
<body>
    <form id="form1" runat="server">
     <asp:Label ID="lblintesta" runat="server"
                Font-Bold="True" Font-Size="X-Large" Style="text-align: center" Text="Errore di accesso al sito"
