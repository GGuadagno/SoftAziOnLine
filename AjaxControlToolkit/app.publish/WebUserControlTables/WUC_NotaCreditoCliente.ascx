<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_NotaCreditoCliente.ascx.vb" Inherits="SoftAziOnLine.WUC_NotaCreditoCliente" %>
        ...
        <td >
            <asp:Panel ID="Panel1" runat="server" Height="100px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                <asp:GridView ID="GridViewDocT" runat="server" AutoGenerateColumns="False" 
                            ...
                            DataSourceID="" EnableTheming="True" GridLines="None">
