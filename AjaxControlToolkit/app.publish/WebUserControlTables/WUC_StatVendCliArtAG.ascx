<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_StatVendCliArtAG.ascx.vb" Inherits="SoftAziOnLine.WUC_StatVendCliArtAG" %>
...
<table style="vertical-align:middle; background-color:Silver; border-style:double; height: 500px; width: 927px;">
            <tr>
                <td>
                    <asp:Panel ID="PanelSelezionaAgente" style="margin-top: 0px;" runat="server" GroupingText="Agenti">
                    <table width="100%">
                        <tr>
