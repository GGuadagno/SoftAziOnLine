<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CambiaStatoOF.ascx.vb" Inherits="SoftAziOnLine.WUC_CambiaStatoOF" %>
        ...
        <td >
            ...
            <asp:Panel ID="PanelBody" runat="server" Height="300px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                ...
                <div style="text-align:left">
                    ...
                    <asp:RadioButton ID="rbtnInCarico" runat="server" Text="In Carico" 
