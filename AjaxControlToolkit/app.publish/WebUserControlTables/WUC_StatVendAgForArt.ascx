<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_StatVendAgForArt.ascx.vb" Inherits="SoftAziOnLine.WUC_StatVendAgForArt" %>
...
<table style="vertical-align:middle; background-color:Silver; border-style:double; height: 260px; width: 927px;" >
            <tr>
                <td>
                    <asp:Panel ID="PanelSelezionaAgente" style="margin-top: 0px;" runat="server" GroupingText="Agenti/Regione">
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td align="left">Seleziona la</td><td>
                            <asp:CheckBox ID="chkRegioni" runat="server" AutoPostBack="True" TabIndex="10" Text="Regione" Checked="false" />
                    ...
                    <td align="left" class="style7">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                ...
                                <div>
                                    <asp:Button ID="btnControllo" runat="server" Text="Controllo" class="btnstyle"
                                         TabIndex="21" />
                                </div>
                                <div style="height: 15px">
                                </div>
