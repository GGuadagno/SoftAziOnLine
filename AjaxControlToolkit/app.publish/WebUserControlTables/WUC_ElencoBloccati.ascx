<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_ElencoBloccati.ascx.vb" Inherits="SoftAziOnLine.WUC_ElencoBloccati" %>
...
<%@ Register Src="~/WebUserControl/WFP_CambiaStatoOC.ascx" TagName="WFPCambiaStatoOC" TagPrefix="wuc4" %>
<style type="text/css">
    .btnstyle1RL
        {
            Width: 140px;
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <wuc4:WFPCambiaStatoOC ID="WFPCambiaStatoOC" runat="server" />
<table border="0" cellpadding="0" frame="box" style="width:auto; height:550px; margin-right:0;">
                    ...
                    <tr>
                        <td>
                            &nbsp;Ricerca per:&nbsp;<asp:DropDownList ID="ddlRicerca" runat="server" 
                                AutoPostBack="True" Width="235px">
                            </asp:DropDownList>
                            &nbsp;<asp:CheckBox ID="checkParoleContenute" runat="server" Text="Parole contenute" Checked="false"/>
                            &nbsp;<asp:TextBox ID="txtRicerca" runat="server" Width="200px"></asp:TextBox>&nbsp;<asp:Button ID="btnRicerca" runat="server" Text="Cerca documento" class="btnstyle1RL" />
            ...
            <tr>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                <%--<div id="divGridViewPrevT" style="overflow-x:auto; overflow-y:hidden;  width:860px; height:195px; border-style:groove;">--%>
                <div id="divGridViewPrevT" style="overflow:auto; width:1110px; height:230px; border-style:groove;">
                        <asp:GridView ID="GridViewPrevT" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                SortExpression="DesStatoDoc"><HeaderStyle Width="15px" Wrap="True" /><ItemStyle 
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                <div id="divGridViewPrevD" style="overflow-x:hidden; overflow-y:hidden; width:1110px; height:250px; border-style:groove;">
            ...
            <td align="left" class="style6">
                    ...
                    <div style="height: 15px">
                        <asp:Button ID="btnStampa" runat="server" class="btnstyle1R" Text="Stampa" Visible="false"/>
                            </div>
                    <div style="height: 15px">&nbsp;</div>
                    <div>
...
<script type = "text/javascript">
    function GridScroll() {
//        $('#<%=GridViewPrevT.ClientID %>').Scrollable({
//            ScrollHeight: 140,        
//        });
//        $('#<%=GridViewPrevD.ClientID %>').Scrollable({
//            ScrollHeight: 230,        
//        });
