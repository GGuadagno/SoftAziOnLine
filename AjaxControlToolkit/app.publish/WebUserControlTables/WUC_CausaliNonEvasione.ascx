<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_CausaliNonEvasione.ascx.vb" Inherits="SoftAziOnLine.WUC_CausaliNonEvasione" %>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:SqlDataSource ID="SqlDSCausNonEvasione" runat="server" 
                            SelectCommand="SELECT Codice, Descrizione FROM CausNonEvasione ORDER BY Descrizione" SelectCommandType="Text" 
                            UpdateCommand="InsertUpdate_CausNonEvasione" 
