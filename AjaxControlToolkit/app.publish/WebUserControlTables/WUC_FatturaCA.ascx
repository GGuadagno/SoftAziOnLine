<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_FatturaCA.ascx.vb" Inherits="SoftAziOnLine.WUC_FatturaCA" %>
    ...
    <tr> 
        <td >
            <asp:SqlDataSource ID="SqlDSDocT" runat="server" 
                            SelectCommand="get_ConTElencoByIDDocumenti" 
            ...
            <asp:Panel ID="PanelBody" runat="server" Height="300px" ScrollBars="Auto" BorderStyle="Solid" BorderWidth="1px">
                <asp:GridView ID="GridViewDocD" runat="server" 
                    ...
                    <Columns>
                        ...
                        SortExpression="Qta_Inviata"><HeaderStyle Wrap="True" /><ItemStyle 
                        Width="10px" /></asp:BoundField>
                        ...
                        SortExpression="Qta_Fatturata"><HeaderStyle Wrap="True" /><ItemStyle 
                        Width="10px" /></asp:BoundField>
