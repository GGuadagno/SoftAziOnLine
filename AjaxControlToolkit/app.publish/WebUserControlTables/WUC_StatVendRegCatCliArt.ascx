<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WUC_StatVendRegCatCliArt.ascx.vb" Inherits="SoftAziOnLine.WUC_StatVendRegCatCliArt" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <br>
<table style="vertical-align:middle; background-color:Silver; border-style:double; height: 450px; width: 927px;" >
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblDallaData" runat="server" Height="16px" Width="100px">Dalla data</asp:Label>
                     ...
                     <asp:Panel ID="PanelCategoria" style="margin-top: 0px;" runat="server" GroupingText="Categoria">
                    <table width="100%">
                        <tr>
