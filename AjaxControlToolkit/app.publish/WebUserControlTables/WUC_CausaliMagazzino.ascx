                        ...
                        <asp:GridView ID="GridViewPrevT" runat="server" AllowPaging="True" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Movimento fra magazzino" ItemStyle-HorizontalAlign="Center" 
                                    SortExpression="Movimento_Magazzini">
                                    <ItemTemplate>
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="PanelDettaglio" style="margin-top: 0px;" runat="server" groupingtext="Dettaglio" Width="1120px" Height="300px" >
                                ...
                                <tr>
                                    ...
                                    <td width ="50%" align="left">
                                         <asp:Label ID="Label28" runat="server" Visible="true" ForeColor="Blue" Width="150px">Magazzino 2</asp:Label>
                                        <asp:DropDownList ID="DDLMagazzino2" runat="server" AppendDataBoundItems="true"
                                            AutoPostBack="true" DataSourceID="SqlDSMagazzino2" 
                                            DataTextField="Descrizione" 
                                            DataValueField="Codice" Width="350px" TabIndex="2" Enabled="false" Visible="true">
                                            <asp:ListItem Text="" Value=""></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:SqlDataSource ID="SqlDSMagazzino2" runat="server"
                                            SelectCommand="SELECT * FROM Magazzini ORDER BY Descrizione">
                                        </asp:SqlDataSource>
                                    </td>
                                </tr>
                                </table>
