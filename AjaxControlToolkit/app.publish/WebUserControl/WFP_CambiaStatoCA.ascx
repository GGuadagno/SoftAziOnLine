<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_CambiaStatoCA.ascx.vb" Inherits="SoftAziOnLine.WFP_CambiaStatoCA" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_CambiaStatoCA.ascx" TagName="CambiaStatoCA" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="CAMBIO STATO CONTRATTI CLIENTI" Width="99%"></asp:Label>
        <wuc:CambiaStatoCA ID="WUCCambiaStatoCA" runat="server" />
    </asp:Panel>
