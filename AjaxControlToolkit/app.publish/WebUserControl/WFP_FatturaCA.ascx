<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_FatturaCA.ascx.vb" Inherits="SoftAziOnLine.WFP_FatturaCA" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_FatturaCA.ascx" TagName="FatturaCA" TagPrefix="wuc" %>
...
<asp:Panel runat="server" CssClass="modalPopup" ID="programmaticPopup" style="display:none;width:auto;padding:10px">
    <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move;background-color:#DDDDDD;border:solid 1px Gray;color:Black;text-align:center;">
        <asp:Label ID="Label1" 
                ...
                Style="text-align:center" Text="FATTURA PARZIALE CONTRATTO CLIENTE" Width="99%"></asp:Label>
        <wuc:FatturaCA ID="WUCFatturaCA" runat="server" />
    </asp:Panel>
    <asp:Panel ID="Panel3" runat="server" Height="25px"><asp:Label ID="lblMessUtente" 
                runat="server" BorderStyle="Outset" Font-Bold="True" Font-Overline="False" 
                Style="text-align:center" Text="Seleziona/modifica Qtà articoli da fatturare" Width="99%"></asp:Label>
        </asp:Panel> 
    <br />        
    <div style="text-align:center;">    
        <asp:Button ID="btnOk" runat="server" Text="OK Emissione Fattura" OnClick="btnOk_Click" />
