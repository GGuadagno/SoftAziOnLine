<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="WFP_Elenco.ascx.vb" Inherits="SoftAziOnLine.WFP_Elenco" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register Src="~/WebUserControlTables/WUC_Elenco.ascx" TagName="WucElenco" TagPrefix="wuc" %>
